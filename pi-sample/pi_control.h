...
void initLEDPins();
// red/green/blue should be in range 0~100
void turnOnLED(int red, int green, int blue);
void turnOffLED();
// readDS18B20Temparature return measured temperature * 10, you should divide it
// whether by 10.0 to get float temperature or by 10 to get integer temperature.
